...
# Read the file
input_file = os.path.join(script_dir, 'CHALLENGE_2_FIRE_DATA_PRESENTATION.md')
slides_file = os.path.join(script_dir, 'CHALLENGE_2_SLIDES_ONLY.md')
speaker_file = os.path.join(script_dir, 'CHALLENGE_2_SPEAKER_NOTES.md')
