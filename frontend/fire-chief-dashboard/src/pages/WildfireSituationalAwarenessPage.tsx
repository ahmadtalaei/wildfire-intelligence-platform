          ...
          <Box sx={{ p: 2 }}>
            ...
            <Accordion defaultExpanded>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Typography variant="subtitle1">[FIRE] Fire Information</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <List dense>
                  <ListItem>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Typography variant="subtitle1">[HERB] Environment</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <List dense>
                  <ListItem>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Typography variant="subtitle1">[HOUSE] Population at Risk</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <List dense>
                  <ListItem>
                  ...
                  <ListItem>
                    <FormControlLabel
                      ...
                      label="[HOUSE] Wildland Urban Interface"
                    />
                  </ListItem>
                  <ListItem>
                    <FormControlLabel
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Typography variant="subtitle1">[FIRE] Fire Hazard Zones</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <List dense>
                  <ListItem>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Typography variant="subtitle1">[HELICOPTER] Emergency Infrastructure</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <List dense>
                  <ListItem>
                    <FormControlLabel
                      ...
                      label="[HELICOPTER] Helicopter Landing Zones"
                    />
                  </ListItem>
                  <ListItem>
                    <FormControlLabel
                  ...
                  <ListItem>
                    <FormControlLabel
                      ...
                      label="[SATELLITE_ANTENNA] Communication Towers"
                    />
                  </ListItem>
                  <ListItem>
                    <FormControlLabel
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMore />}>
                <Typography variant="subtitle1">[THERMOMETER] Weather Monitoring</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <List dense>
                  <ListItem>
                    <FormControlLabel
                      ...
                      label="[THERMOMETER] Weather Stations (RAWS)"
                    />
                  </ListItem>
                </List>
              </AccordionDetails>
        ...
        <Box sx={{ flex: 1, position: 'relative' }}>
          ...
          >
            <Typography variant="body2" sx={{ mb: 1, fontWeight: 'bold' }}>
              {mapMode === 'live_weather' ? '[THERMOMETER] Live Weather Analysis' : mapMode === 'windy' ? '🌪️ Professional Weather Analysis' : '[FIRE] Fire Behavior Analysis'}
            </Typography>
