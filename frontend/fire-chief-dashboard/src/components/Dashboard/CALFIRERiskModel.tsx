                  ...
                  <TableCell>
                    <Box>
                      <Typography variant="caption" display="block">
                        [THERMOMETER] Weather: {assessment.components.weatherRisk}%
                      </Typography>
                      <Typography variant="caption" display="block">
                        [DROPLET] Fuel Moisture: {assessment.components.fuelMoistureRisk}%
                      </Typography>
                      <Typography variant="caption" display="block">
                        🏔️ Topography: {assessment.components.topographyRisk}%
                      </Typography>
                      <Typography variant="caption" display="block">
                        [HERB] Vegetation: {assessment.components.vegetationRisk}%
                      </Typography>
                    </Box>
                  </TableCell>
